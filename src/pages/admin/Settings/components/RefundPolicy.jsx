...
import { getAllRefundPolicies, createRefundPolicy, updateRefundPolicy, deleteRefundPolicy } from '../../../../services/admin/apiCms';
...
function RefundPolicy() {
    ...
    const fetchRefundPolicies = async () => {
        try {
            const res = await getAllRefundPolicies(type);
            setData(res.data || []);
        } catch (error) {
    ...
    return (
        <div className="p-6">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-2xl font-bold">Refund Policy {type && `(${type.toUpperCase()})`}</h2>
                <Button
                    type="primary"
                    icon={<FaPlus />}
            ...
            {/* Create/Edit Modal */}
            <Modal
                title={editingItem ? 'Edit Refund Policy' : 'Create Refund Policy'}
                open={modalVisible}
