      ...
      <Form form={form} layout="vertical">
        ...
        <Form.Item
          ...
          rules={[
            ...
            { max: 30, message: "Variant name cannot exceed 30 characters" },
              ...
              validator(_, value) {
                ...
                if (/^\d+$/.test(value)) {
                  return Promise.reject(
                    new Error("Variant name cannot be only numbers")
                  );
                }
                ...
                if (!value.trim()) {
                  return Promise.reject(
                    new Error("Variant name cannot be empty or spaces only")
                  );
                }
        ...
        <Row gutter={16}>
          <Col span={8}>
            <Form.Item
              ...
              name="originalPrice"
              rules={[
                { required: true, message: "Enter original price" },
