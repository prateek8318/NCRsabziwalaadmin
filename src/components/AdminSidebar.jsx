...
const AdminSidebar = ({ collapsed, settingData }) => {
  ...
  // Only update openKeys from URL on initial mount or when collapsed changes
  useEffect(() => {
  ...
  console.log("selected", selectedKey, "openKeys", openKeys);
