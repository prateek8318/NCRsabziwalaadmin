...
// console.log(axiosInstance,"axiosInstanceaxiosInstanceaxiosInstance")
...
export const getAllSubCategory = async (categoryId) => {
    ...
    if (categoryId != undefined) {
        url = `/api/admin/subcategory/list?categoryId=${categoryId}`
    } else {
        url = `/api/admin/subcategory/list`
    }
    try {
...
export const updateCategorySortOrder = async (data) => {
    await axiosInstance.post('/api/admin/category/setorder', data)
}
